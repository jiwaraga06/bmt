...
import 'package:bmt/source/pages/Menu/PackingList/filter.dart';
import 'package:bmt/source/pages/Menu/PackingList/insert.dart';
...
class RouterNavigation {
  Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case FILTER_PACKING_LIST:
        return MaterialPageRoute(builder: (context) => FilterPackingList());
      case INSERT_PACKING_LIST:
        return MaterialPageRoute(builder: (context) => InsertPackingList());
      // PUT AWAY
      case PUT_AWAY:
